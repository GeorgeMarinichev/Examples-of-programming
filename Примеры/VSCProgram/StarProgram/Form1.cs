namespace StarProgram
{
    public partial class Form1 : Form
    {
        ...
        private void DrawStar(Star star)
        {
            ...
            float starSize = Map(star.Z, 0, pictureBox1.Width, 12, 0);
        ...
        {
            //var result = Map(10, 0, 100, 0, 1000);
    ...
    public class Star
    {
        public float X { get; set; }//Свойство звезд
        public float Y { get; set; }//Свойство звезд
        public float Z { get; set; }//Свойство звезд
